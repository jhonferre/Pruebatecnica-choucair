...
public class FormPage {
    ...
    public static final Target INPUT_ZIP = Target.the("Ingresar Codigo Postal")
            .located(By.id("zip"));
    public static final Target CLICK_COUNTRY = Target.the("Click desplegable pais Pais")
    ...
    public static final Target CLICK_COMPUTER = Target.the("CLICK en Seleccionar Computadora")
    ...
    public static final Target CLICK_VERSION = Target.the("CLICK en Seleccionar VERSION")
    ...
    public static final Target CLICK_LANGUAGE = Target.the("CLICK en Seleccionar Lenguaje")
